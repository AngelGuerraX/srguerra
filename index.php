...
$rutas_sin_layout = [
    ...
    'productos/logic', 'guardar-producto', // <--- Agregado para productos
    'actualizar-estado-pedido', 
    'portal/login', 'portal/dashboard', 'portal/logic', 'portal/detalle', 'portal/historial',
    'pedidos/imprimir_hoja_ruta', // Hoja de ruta limpia para imprimir
    'saas/logic', 'finanzas/logic'
];
...
switch ($ruta) {
    ...
    case 'actualizar-estado-pedido':
        $_GET['action'] = 'cambiar_estado'; // Truco para reutilizar logic
    ...
    // Rutas específicas para guardar productos (Corrección del error 404)
    case 'guardar-producto': // Ruta antigua o directa
    case 'productos/logic':  // Ruta estándar
        include 'modules/inventario/logic.php'; // Apuntamos a la lógica de inventario/productos
        break;
    ...
    case 'finanzas/productos': include 'modules/finanzas/productos.php'; break;
    case 'finanzas/logic': include 'modules/finanzas/logic.php'; break;

    // --- CONFIGURACIÓN ---
    case 'configuracion': include 'modules/configuracion/perfil.php'; break; // Actualizado a perfil.php
    case 'configuracion/logic': include 'modules/configuracion/logic.php'; break;
    case 'saas': include 'modules/saas/index.php'; break;
    ...
    case 'finanzas/rentabilidad':
        include 'modules/finanzas/rentabilidad.php';
        break;
    ...
    default:
        ...
        echo "<p class='text-muted'>La ruta '<b>$ruta</b>' no existe en el sistema.</p>";
